...
<svelte:head>
	<title>Tổng quan - Admin Foodstore</title>
</svelte:head>
			...
			>
				<div class="flex items-center justify-between">
					<div class="rounded-xl bg-emerald-50 p-3 text-emerald-600">
						<Icon name="tabler:chart-bar" class="h-6 w-6" />
					</div>
			...
			>
				<div class="flex items-center justify-between">
					<div class="rounded-xl bg-blue-50 p-3 text-blue-600">
						<Icon name="tabler:calendar" class="h-6 w-6" />
					</div>
					<div class="text-right">
			...
			>
				<div class="flex items-center justify-between">
					<div class="rounded-xl bg-purple-50 p-3 text-purple-600">
						<Icon name="tabler:users" class="h-6 w-6" />
					</div>
					<div class="text-right">
			...
			>
				<div class="flex items-center justify-between">
					<div class="rounded-xl bg-orange-50 p-3 text-orange-600">
						<Icon name="tabler:clock" class="h-6 w-6" />
					</div>
					<div class="text-right">
