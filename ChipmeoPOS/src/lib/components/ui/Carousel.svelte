<script lang="ts">
	...
	import type { CarouselOptions, CarouselInterface } from 'flowbite';
	...
	onMount(() => {
		...
		new Carousel(el, items, options);
	});
</script>

<div {id} data-carousel={autoSlide ? 'slide' : 'static'} class="relative w-full {className}">
