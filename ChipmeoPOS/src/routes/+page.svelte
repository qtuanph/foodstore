...
<svelte:head>
	<title>Đăng nhập - Chipmeo Foodstore</title>
</svelte:head>
	...
	<div class="w-full max-w-md">
		<div class="border border-default bg-neutral-primary-soft rounded-base shadow-sm p-6 md:p-8">
			<div class="mb-6 flex flex-col items-center">
				<img src="/cmfs_removed_bg.png" class="mb-4 h-16 w-16 rounded-full" alt="Chipmeo Logo" />
				<h1 class="mb-1 text-2xl font-bold text-heading">Chipmeo Foodstore</h1>
