...
public interface IOrderRepository
{
    ...
    Task<IEnumerable<Order>> GetBySourceIdAsync(Guid sourceId, CancellationToken cancellationToken = default);
    ...
    Task<int> CountActiveOrdersBySourceIdAsync(Guid sourceId, Guid? excludeOrderId = null, CancellationToken cancellationToken = default);
