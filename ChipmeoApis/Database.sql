...
CREATE TABLE categories (
    ...
    image_url NVARCHAR(500), -- https://media.chipmeo.io.vn/categories/xxx.jpg
...
CREATE TABLE menu_items (
    ...
    image_url NVARCHAR(500), -- https://media.chipmeo.io.vn/menu-items/xxx.jpg
    is_active BIT DEFAULT 1,
    created_at DATETIME2 DEFAULT GETDATE(),
...
CREATE TABLE combos (
    ...
    description NVARCHAR(500),
    image_url NVARCHAR(500), -- https://media.chipmeo.io.vn/combos/xxx.jpg
    is_active BIT DEFAULT 1,
    created_at DATETIME2 DEFAULT GETDATE()
);
...
CREATE TABLE employees (
    ...
    email NVARCHAR(100),
    phone NVARCHAR(20),
    avatar_url NVARCHAR(500), -- https://media.chipmeo.io.vn/avatars/xxx.jpg
    role_id INT NOT NULL,
    is_active BIT DEFAULT 1,
...
-- Centralized storage at https://media.chipmeo.io.vn/
-- Folder structure:
...
CREATE TABLE media (
    ...
    file_url NVARCHAR(500) NOT NULL, -- Full URL: https://media.chipmeo.io.vn/menu-items/abc.jpg
